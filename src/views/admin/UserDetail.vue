                  ...
                  <tr v-for="payment in payments" :key="payment.id" class="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td class="px-6 py-4 text-right">
                      <div class="flex justify-end gap-1.5">
                        ...
                        <router-link :to="{ name: 'PaymentDetailAdmin', params: { id: payment.id } }" class="p-1.5 bg-blue-50 text-blue-600 border border-blue-100 rounded-lg hover:bg-blue-100 transition-colors" title="Ver Detalles">
