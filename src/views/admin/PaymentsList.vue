          ...
          <tr v-for="pay in filteredPayments" :key="pay.id" class="hover:bg-slate-50/50 transition-colors">
            ...
            <td class="px-6 py-4 text-right">
              <div class="flex justify-end gap-1.5">
                ...
                <router-link :to="{ name: 'PaymentDetailAdmin', params: { id: pay.id } }" class="p-2 bg-indigo-50 text-indigo-600 border border-indigo-100 rounded-lg hover:bg-indigo-100 transition-colors" title="Ver Expediente">
